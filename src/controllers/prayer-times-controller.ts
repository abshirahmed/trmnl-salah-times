...
/**
 * Parameters for getPrayerTimes method
 */
...
/**
 * Controller for prayer times functionality
 */
export class PrayerTimesController {
   ...
   */
  async getPrayerTimes(params: GetPrayerTimesParams) {
...
export const prayerTimesController = new PrayerTimesController();
